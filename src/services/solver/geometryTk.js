...
// Смена варианта geo: позиции имеют несовместимую семантику, поэтому весь буфер обнуляется.
// Источник: julia, src/core/03_tk.jl::unpack — читает geo[1:k] по типу, хвост буфера не используется.
