...
const GEOMETRY_CHECK_DIAGNOSTICS = Object.freeze([
    ["edge13", "Длина ребра 13 не превышает 0,03 мм"],
    ["edge57", "Длина ребра 57 не превышает 0,03 мм"],
    ["edge15", "Длина ребра 15 не превышает 0,03 мм"],
    ["edge37", "Длина ребра 37 не превышает 0,03 мм"],
    ["edge26", "Длина ребра 26 не превышает 0,03 мм"],
    [
        "parallel13And24",
