...
import { TASK_OPERATION_LABELS } from "./tasks/TaskOperationDialog.jsx";
  ...
  return (
    <>
      ...
      >
        ...
        {props.taskActions && <section class="side-panel-section">
          <div class="side-panel-section-title">Работа с заданиями</div>
